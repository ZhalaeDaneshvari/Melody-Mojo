...
const ROUTES = array(
  "/" => "pages/home.php",
  "/song-details" => "pages/song-details.php",
  "/welcome" => "pages/welcome.php",
  "/home-admin" => "pages/home-admin.php",
  "/add-admin" => "pages/add-admin.php",
  "/add-consumer" => "pages/add-consumer.php",
  "/edit-song" => "pages/edit-song.php",
  "/login" => "pages/login.php",
  "/show-lyrics" => "pages/show-lyrics.php",
  "/edit-entry" => "pages/edit-entry.php"
